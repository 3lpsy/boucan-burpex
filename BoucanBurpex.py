...
class ApiClient(object):
    ...
    def build_request(self, meth, url, token):
        ...
        requestString.write("\r\n")
        requestString.write(
            "User-Agent: Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.2.28) Gecko/00000000 Firefox/30.0.00\r\n"
        )
...
class BurpExtender(IBurpExtender, ITab):
    ...
    def buildPanel(self):
        ...
        updateConfButton = swing.JButton(
            "Update Configuration", actionPerformed=self.updateConfEvent
        )
